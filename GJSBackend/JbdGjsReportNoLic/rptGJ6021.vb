...
Interface InterfaceRptGJ6021
    Sub sub1(wkDSRep As DataSet)
End Interface
Public Class rptGJ6021
    Implements InterfaceRptGJ6021
    ''' <summary>
    ''' 2行ごとの線引きカウント
    ''' </summary>
    ''' <remarks></remarks>
    ...
    'Private Sub rptGJ6021_ReportStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ReportStart
    '    LineCount = 0
    '    wSeq = 0
    ...
    Sub sub1(wkDSRep As DataSet) Implements InterfaceRptGJ6021.sub1
