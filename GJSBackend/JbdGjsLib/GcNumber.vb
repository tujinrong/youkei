...
Public Class GcNumber
    Inherits GrapeCity.Win.Editors.GcNumber
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'GcNumber
        '
        Me.Fields.IntegerPart.MinDigits = 1
    ...
    ''' </summary>
    ''' 
    Private _ZeroSuppress As Boolean = False
    <System.ComponentModel.DefaultValue(False)> _
       <System.ComponentModel.Description("InputCheckプロパティがTrueの場合、Zeroを空白に置き換えるかを設定します。Trueの場合、ゼロは未入力とみなします。")> _
    Public Property ZeroSuppress As Boolean

        Get
            Return _ZeroSuppress
        End Get
    ...
    Protected Overrides Sub OnTextChanged(e As EventArgs)
        ...
        If Me.InputCheck Then
            If _ZeroSuppress Then
                If Me.Value Is Nothing OrElse Me.Value = 0 Then
                    Me.BackColor = GjsDefaultColor.MandatoryColor
                Else
                    Me.BackColor = GjsDefaultColor.NormalColor
                End If
