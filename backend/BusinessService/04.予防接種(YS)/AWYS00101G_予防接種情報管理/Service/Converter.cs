...
namespace BCC.Affect.Service.AWYS00101G
{
    public class Converter : CmConerterBase
    {
        ...
        /// </summary>
        public static List<AiKeyValue> GetParameters(string atenano, string hanyomaincd, int hanyosubcd, bool rirekihyoji, int kbn)
        {
        ...
        /// 罹患テーブル
        /// </summary>
        public static tt_ysrikanDto GetDto(SessyuRikanBaseVm vm, SaveRikanRequest req)
        {
            var dto = new tt_ysrikanDto();

            dto.atenano = req.atenano;                                          //宛名番号
            dto.rikancd = GetCd(vm.rikan);                                      //罹患コード	
            dto.haakuymd = vm.haakuymd;                                         //把握日
        ...
        /// 予防接種その他テーブル
        /// </summary>
        public static tt_yssonotaDto GetDto(tt_yssonotaDto dto, SaveOtherRequest req, EnumActionType? kbn)
        {
            if (kbn == EnumActionType.Insert)
            {
                //新規の場合
