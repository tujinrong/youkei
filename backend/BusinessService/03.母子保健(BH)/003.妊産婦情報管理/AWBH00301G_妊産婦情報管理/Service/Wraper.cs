...
namespace BCC.Affect.Service.AWBH00301G
{
    public class Wraper : CmWraperBase
    {
        ...
        /// メニュー名称リスト
        /// </summary>
        public static List<MenuInfoVM> GetMenuInfoVMList(DaDbContext db, IOrderedEnumerable<tm_bhkksyosaimenuDto> dtl, string bosikbn, string atenano, long torokuno)
        {
