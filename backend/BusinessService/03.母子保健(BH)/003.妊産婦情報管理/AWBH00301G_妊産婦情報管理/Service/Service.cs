...
namespace BCC.Affect.Service.AWBH00301G
{
    ...
    public class Service : CmServiceBase
    {
        ...
        private SearchDetailResponse SearchDetail(DaDbContext db, SearchDetailRequest req)
        {
            ...
            //B、メニュー名称リストを取得
            var menudtl = db.tm_bhkksyosaimenu.SELECT.WHERE.ByKey(req.bosikbn).GetDtoList().OrderBy(e => e.orderseq);
            ...
            //集約コードパターン
            var patternno = CmLogicUtil.GetPatternno(AWBH00301G, 拡張_予約_保健指導業務区分._02);
        ...
        public static string GetMenuNameStr(DaDbContext db, string bosikbn)
        {
            ...
            var dtl = db.tm_bhkksyosaimenu.SELECT.WHERE.ByKey(bosikbn).GetDtoList().OrderBy(e => e.orderseq);
