...
public static class CommonUtil
{
    ...
    /// 出力情報を取得
    /// </summary>
    public static Dictionary<string, object> GetOutPutInfo(OutPutInfoVM? outPutInfo, string filenm, long? rirekiseq,string? jobId)
    {
        //出力情報
        ...
        outputInfoDic.Add(DaEucService.CONDITION_RIREKI_SEQ, rirekiseq!);
        outputInfoDic.Add(DaEucService.CONDITION_JOB_ID, jobId!);
