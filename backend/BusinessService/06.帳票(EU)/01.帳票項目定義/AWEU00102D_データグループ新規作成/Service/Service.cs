    ...
    public class Service : CmServiceBase
    {
        ...
        public SearchResponse Search(SearchRequest req)
        {
            return Nolock(req, db =>
            {
                ...
                var dtl = db.Session.Query<tm_eutableitemDto>($"SELECT * FROM tm_eutableitem WHERE {nameof(tm_eutableitemDto.daibunrui)}='{list[0]}' ORDER BY {nameof(tm_eutableitemDto.orderseq)},{nameof(tm_eutableitemDto.itemid)}");
