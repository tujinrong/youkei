...
namespace BCC.Affect.Service.AWEU00103D
{
    ...
    public class Service : CmServiceBase
    {
        ...
        {
            var dtl = DaEucCacheService.GetEutableitemDtoList(db).Where(e=> !existSqlColumnSet.Contains(e.sqlcolumn) && buruilist.Contains(e.daibunrui)).OrderBy(e => e.daibunrui).ThenBy(e => e.orderseq).ThenBy(e => e.itemid).ToList();
            return dtl;
        }
