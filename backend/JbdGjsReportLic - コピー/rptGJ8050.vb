...
Imports GrapeCity.Documents.Pdf.Operators
Interface InterfaceRptGJ8050
    Sub sub1(wkDSRep As DataSet)
    Sub sub2(dstDataRpt As DataSet, strRptNm As String, strOutPath As String, ByVal strDataMember As String)
...
Public Class rptGJ8050
    ...
    Sub sub1(dstDataSet As DataSet) Implements InterfaceRptGJ8050.sub1
        ''--------------------------------------------------
        ''ＰＤＦ出力
        ''--------------------------------------------------
    ...
    Sub sub2(dstDataRpt As DataSet, strRptNm As String, strOutPath As String, ByVal strDataMember As String) Implements InterfaceRptGJ8050.sub2
        ...
        ' 上下の余白を 1.0cm に設定します。
        rptPdf.PageSettings.Margins.Top = GrapeCity.ActiveReports.SectionReport.CmToInch(0.0)
        rptPdf.PageSettings.Margins.Bottom = GrapeCity.ActiveReports.SectionReport.CmToInch(0.0)
        ' 左右の余白を 1.0cm に設定します。
    ...
    Sub sub3(dstDataRpt As DataSet, strRptNm As String, strOutPath As String, ByVal strDataMember As String) Implements InterfaceRptGJ8050.sub3
    ...
    Sub sub4(dstDataSet As DataSet) Implements InterfaceRptGJ8050.sub4
        ''--------------------------------------------------
        ''ＰＤＦ出力
        ''--------------------------------------------------
        'If Not f_Pdf_Output(rptPdf, dstDataSet, dstDataSet.Tables(0).TableName) Then
