...
Interface InterfaceRptGJ2051
    Sub sub1(wkDSRep As DataSet, pSyoriKbn As Integer)
End Interface
Public Class rptGJ2051
    Implements InterfaceRptGJ2051
    Property pSyoriKbn As Integer
    Property pKikin2 As Boolean
    Property imgInei As Object
    ...
    Private Sub Detail_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail.Format
        ...
        txt_HD_TEXT.Text = "　平素は家畜防疫互助事業にご協力いただきありがとうございます。" & vbCrLf & _
                           ...
                           "業積立金の返還金と相殺したところ、下記のとおり残金が生じましたのでご返金させていただき" & vbCrLf & _
                           "ます。"

        '返還明細
        lbl_HD1.Text = "第" & ZEN_KI_N.Text & "期生産者積立金(既存分)　返還金"
        lbl_HD2.Text = "第" & ZEN_KI_N.Text & "期積立金(既存分)"
        lbl_HD3.Text = "第" & ZEN_KI_N.Text & "期生産者積立金(追加分)　返還金"
        lbl_HD4.Text = "第" & ZEN_KI_N.Text & "期積立金(追加分)"

        '請求明細
        lbl_DTL_FT1.Text = "　積立金合計(Ｃ) × " & TESURYO_RITU.Text & "％(100円未満切捨)"
        lbl_DTL_FT2.Text = "　第" & TOU_KI_N.Text & "期請求金額合計(Ｆ)"
    ...
    Sub sub1(wkDSRep As DataSet, pSyoriKbn As Integer) Implements InterfaceRptGJ2051.sub1
