...
'db.tt_aflog.UPDATE.Execute(dto);
        ...
        ''' <summary>
        ''' 通信ログDaRequestBase request, DaResponseBase response, string? msg
        ''' </summary>
        Public Shared Function WriteTusinLog(db As DaDbContext, request As DaRequestBase, response As Object, msg As String) As Long
            Try
                Dim dto As tt_aftusinlogDto = New tt_aftusinlogDto()
                dto.sessionseq = request.sessionid
...
#Region "共通ログ"
        ...
        Public Shared Sub WriteDbMessage(db As DaDbContext, msg As String)
            ...
            dto.msg = msg
            dto.sessionseq = Clng(db.Session.SessionData(DaConst.SessionID))
