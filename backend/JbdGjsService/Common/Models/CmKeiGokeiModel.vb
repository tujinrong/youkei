...
Namespace JBD.GJS.Service
    Public Class CmKeiGokeiModel
        ...
        Public Property NIKUYOKEI As Integer? = Nothing   '肉用鶏
        ...
        Public Property HOROHOROCHO As Integer? = Nothing   'ほろほろ鳥
        Public Property SICHIMENCHO As Integer? = Nothing   '七面鳥
        Public Property DACHO As Integer? = Nothing   'だちょう
