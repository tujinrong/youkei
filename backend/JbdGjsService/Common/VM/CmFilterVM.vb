...
Namespace JBD.GJS.Service
    Public Module CmFilterVM
        ...
        Public Class CommonFilterVM
            Public Property jyokbn As Db.Enum詳細検索条件区分          '条件区分
            ...
            Public Property ctrltype As Db.Enumコントローラータイプ    'コントローラータイプ
            ...
            Public Property searchitemkbn As Db.Enum参照ダイアログ項目区分  '参照ダイアログ項目区分
        End Class
    End Module
End Namespace
