...
'*　　①　フォーム名　　　  frmGJ2110.vb
'*
'*　　②　機能概要　　　　　家畜防疫互助基金請求書兼返還金督促通知書（一部徴収）発行処理
'*
...
#Region "frmGJ2110_Load Form_Loadイベント"

    '------------------------------------------------------------------
    'プロシージャ名  :frmGJ2110_Load
    '説明            :Form_Loadイベント
    '------------------------------------------------------------------
    Private Sub frmGJ2110_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim ret As Boolean
...
#Region "f_Save 請求入金更新"
    ...
    Private Function f_Save() As Boolean
        ...
        Try
            ...
            '処理区分
            Cmd.CommandText = "PKG_GJ2110.GJ2110_TOKUSOKU"
            '--------------------
            '請求
            '--------------------
            '期
                ...
                Else
                    ...
                    Else
                        ...
                        If WordHenkan("N", "S", .Rows(0)("SEIKYU_DATE_MIN")) <> WordHenkan("N", "S", .Rows(0)("SEIKYU_DATE_MAX")) Then
                            ...
                            date_SEIKYU_DATE.Value = Nothing
                        Else
                            date_SEIKYU_DATE.Value = CDate(WordHenkan("N", "S", .Rows(0)("SEIKYU_DATE_MAX")))
                        End If
                    End If
                ...
                If .Rows.Count > 0 Then
                    ...
                    Else
                        ...
                        If Show_MessageBox_Add("Q012",
                           ...
                           "生産者積立金等請求書兼返還通知書(徴収)(督促状)を" & vbCrLf & "発行してもよろしいですか。") = System.Windows.Forms.DialogResult.No Then
                            Exit Try
                        End If
                        'End If
    ...
    Private Function f_make_SQL(ByRef wSql As String) As Boolean
        ...
        Try
            ...
            If Not f_Where_Set(1, wWHERE) Then
                wWHERE = ""
                'エラーリスト出力なし
                'Show_MessageBox_Add("W020", "指定された請求（返還）処理") '@0がありません     '2017/07/20　削除
                Exit Try
            End If
            ...
            wSql &= "     SUM(WK2.TUMITATE_KIN) TUMITATE_KIN,"
