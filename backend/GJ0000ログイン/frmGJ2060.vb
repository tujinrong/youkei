...
'*　　①　フォーム名　　　  frmGJ2060.vb
'*
'*　　②　機能概要　　　　　互助金生産者積立金等返還通知書（全額）発行処理
'*
'*　　③　作成日　　　　　　2015/03/20  BY JBD
'*
'*　　④　更新日            
'*
'*******************************************************************************
...
#Region "frmGJ2060_Load Form_Loadイベント"

    '------------------------------------------------------------------
    'プロシージャ名  :frmGJ2060_Load
    '説明            :Form_Loadイベント
    '------------------------------------------------------------------
    Private Sub frmGJ2060_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim ret As Boolean
...
#Region "f_ObjectClear 画面クリア処理"
    ...
    Private Function f_ObjectClear(ByVal wKbn As String) As Boolean
        ...
        Try
            ...
            '請求処理へ
            'R05年度 OSバージョンアップ　既存バグ修正のため変更 2024/03/12 JBD453 UPD START
