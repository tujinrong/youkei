...
Interface InterfaceRptGJ2061
    Sub sub1(wkDSRep As DataSet, pFlag As Integer
             )
End Interface

Public Class rptGJ2061
    Implements InterfaceRptGJ2061
    ...
    Sub sub1(wkDSRep As DataSet, pFlag As Integer) Implements InterfaceRptGJ2061.sub1
