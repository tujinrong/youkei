...
Interface InterfaceRptGJ2050
    Sub sub1(wkDSRep As DataSet, pSyoriKbn As Integer)
End Interface
Public Class rptGJ2050
    Implements InterfaceRptGJ2050
    ...
    Sub sub1(wkDSRep As DataSet, pSyoriKbn As Integer) Implements InterfaceRptGJ2050.sub1
        'Using wkAR As New rptGJ2050
        '    '処理区分
