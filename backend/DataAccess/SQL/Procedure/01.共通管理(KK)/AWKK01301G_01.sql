...
*******************************************************************/
/*==============================head==============================*/
CREATE OR REPLACE FUNCTION sp_awkk01301g_01_head(
    nendo_in integer,
...
BEGIN
    ...
    WITH filtered_data AS (
        ...
        WHERE
            ...
            AND t1.zentaikobetukbn = '1'                                                             --全体抽出のみ
...
$FUNCTION$
/*==============================body==============================*/
CREATE OR REPLACE FUNCTION sp_awkk01301g_01_body(
    nendo_in integer,
    tyusyututaisyocd_in character varying,
    tyusyutunaiyo_in character varying,
    regdttmf_in character varying,
