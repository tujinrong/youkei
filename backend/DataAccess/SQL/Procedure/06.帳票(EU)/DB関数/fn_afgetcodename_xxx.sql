...
CREATE OR REPLACE FUNCTION fn_afgetcodename(tablename_in character varying, codeitemname_in character varying, nameitemname_in character varying, maincode_in character varying, subcode_in integer, code_in character varying)
