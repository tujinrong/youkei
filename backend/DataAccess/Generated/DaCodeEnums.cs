...
namespace BCC.Affect.DataAccess
{
    ...
    ///</summary>
     public enum EnumNmKbn : long
     {
        ...
        拡張事業業務 = 1000 * 100000000L + 46,
        拡張事業種類 = 1000 * 100000000L + 47,
        ...
        拡張_予約_保健指導業務区分 = 1001 * 100000000L + 101,
    ...
    ///</summary>
     public enum EnumCtrlKbn : long
     {
        ...
        拡張事業関連上限件数 = 1000 * 100000000L + 7,
        同一世帯員更新フラグ = 1001 * 100000000L + 2,
        付番開始番号 = 1001 * 100000000L + 3,
        一次結果チェック区分 = 1002 * 100000000L + 2,
        予防接種情報管理エラーチェック区分 = 1004 * 100000000L + 1,
        予防接種対象者抽出エラーチェック区分 = 1004 * 100000000L + 2,
    ...
    ///</summary>
     public enum EnumHanyoKbn : long
     {
        ...
        拡張事業１_予備_フリー項目グループ2 = 1002 * 100000000L + 251,
        ...
        回数コード_1回目から2回目 = 1004 * 100000000L + 22,
        回数コード_1回目から3回目 = 1004 * 100000000L + 23,
        回数コード_初回1回目から初回3回目_追加 = 1004 * 100000000L + 24,
        回数コード_1期初回3回_追加 = 1004 * 100000000L + 25,
        回数コード_1期初回2回_追加_2期 = 1004 * 100000000L + 26,
        回数コード_1期から2期_5期 = 1004 * 100000000L + 27,
        回数コード_1期から2期 = 1004 * 100000000L + 28,
        風しん追加的対策クーポン券の予診費用 = 1004 * 100000000L + 29,
        風しん追加的対策クーポン券の接種費用 = 1004 * 100000000L + 30,
        業務区分_帳票 = 1006 * 100000000L + 1,
        帳票グループ = 1006 * 100000000L + 2,
        フォント表示の設定 = 1006 * 100000000L + 3,
        ...
        拡張事業１検査方法 = 3019 * 100000000L + 250001,
        拡張事業１用一次検診コード = 3019 * 100000000L + 250002,
        拡張事業２検査方法 = 3019 * 100000000L + 250201,
        拡張事業２用一次検診コード = 3019 * 100000000L + 250202,
        拡張事業３検査方法 = 3019 * 100000000L + 250401,
        拡張事業３用一次検診コード = 3019 * 100000000L + 250402,
        拡張事業４検査方法 = 3019 * 100000000L + 250601,
        拡張事業４用一次検診コード = 3019 * 100000000L + 250602,
        拡張事業５検査方法 = 3019 * 100000000L + 250801,
        拡張事業５用一次検診コード = 3019 * 100000000L + 250802,
        拡張事業６検査方法 = 3019 * 100000000L + 251001,
        拡張事業６用一次検診コード = 3019 * 100000000L + 251002,
        拡張事業７検査方法 = 3019 * 100000000L + 251201,
        拡張事業７用一次検診コード = 3019 * 100000000L + 251202,
        拡張事業８検査方法 = 3019 * 100000000L + 251401,
        拡張事業８用一次検診コード = 3019 * 100000000L + 251402,
        拡張事業９検査方法 = 3019 * 100000000L + 251601,
        拡張事業９用一次検診コード = 3019 * 100000000L + 251602,
        拡張事業１０検査方法 = 3019 * 100000000L + 251801,
        拡張事業１０用一次検診コード = 3019 * 100000000L + 251802,
        拡張事業１１検査方法 = 3019 * 100000000L + 252001,
        拡張事業１１用一次検診コード = 3019 * 100000000L + 252002,
        拡張事業１２検査方法 = 3019 * 100000000L + 252201,
        拡張事業１２用一次検診コード = 3019 * 100000000L + 252202,
        拡張事業１３検査方法 = 3019 * 100000000L + 252401,
        拡張事業１３用一次検診コード = 3019 * 100000000L + 252402,
        拡張事業１４検査方法 = 3019 * 100000000L + 252601,
        拡張事業１４用一次検診コード = 3019 * 100000000L + 252602,
        拡張事業１５検査方法 = 3019 * 100000000L + 252801,
        拡張事業１５用一次検診コード = 3019 * 100000000L + 252802,
        拡張事業１６検査方法 = 3019 * 100000000L + 253001,
        拡張事業１６用一次検診コード = 3019 * 100000000L + 253002,
        拡張事業１７検査方法 = 3019 * 100000000L + 253201,
        拡張事業１７用一次検診コード = 3019 * 100000000L + 253202,
        拡張事業１８検査方法 = 3019 * 100000000L + 253401,
        拡張事業１８用一次検診コード = 3019 * 100000000L + 253402,
        拡張事業１９検査方法 = 3019 * 100000000L + 253601,
        拡張事業１９用一次検診コード = 3019 * 100000000L + 253602,
        拡張事業２０検査方法 = 3019 * 100000000L + 253801,
        拡張事業２０用一次検診コード = 3019 * 100000000L + 253802,
        拡張事業２１検査方法 = 3019 * 100000000L + 254001,
        拡張事業２１用一次検診コード = 3019 * 100000000L + 254002,
        拡張事業２２検査方法 = 3019 * 100000000L + 254201,
        拡張事業２２用一次検診コード = 3019 * 100000000L + 254202,
        拡張事業２３検査方法 = 3019 * 100000000L + 254401,
        拡張事業２３用一次検診コード = 3019 * 100000000L + 254402,
        拡張事業２４検査方法 = 3019 * 100000000L + 254601,
        拡張事業２４用一次検診コード = 3019 * 100000000L + 254602,
        拡張事業２５検査方法 = 3019 * 100000000L + 254801,
        拡張事業２５用一次検診コード = 3019 * 100000000L + 254802,
        拡張事業２６検査方法 = 3019 * 100000000L + 255001,
        拡張事業２６用一次検診コード = 3019 * 100000000L + 255002,
        拡張事業２７検査方法 = 3019 * 100000000L + 255201,
        拡張事業２７用一次検診コード = 3019 * 100000000L + 255202,
        拡張事業２８検査方法 = 3019 * 100000000L + 255401,
        拡張事業２８用一次検診コード = 3019 * 100000000L + 255402,
        拡張事業２９検査方法 = 3019 * 100000000L + 255601,
        拡張事業２９用一次検診コード = 3019 * 100000000L + 255602,
        拡張事業３０検査方法 = 3019 * 100000000L + 255801,
        拡張事業３０用一次検診コード = 3019 * 100000000L + 255802,
        拡張事業３１検査方法 = 3019 * 100000000L + 256001,
        拡張事業３１用一次検診コード = 3019 * 100000000L + 256002,
        拡張事業３２検査方法 = 3019 * 100000000L + 256201,
        拡張事業３２用一次検診コード = 3019 * 100000000L + 256202,
        拡張事業３３検査方法 = 3019 * 100000000L + 256401,
        拡張事業３３用一次検診コード = 3019 * 100000000L + 256402,
        拡張事業３４検査方法 = 3019 * 100000000L + 256601,
        拡張事業３４用一次検診コード = 3019 * 100000000L + 256602,
        拡張事業３５検査方法 = 3019 * 100000000L + 256801,
        拡張事業３５用一次検診コード = 3019 * 100000000L + 256802,
        拡張事業３６検査方法 = 3019 * 100000000L + 257001,
        拡張事業３６用一次検診コード = 3019 * 100000000L + 257002,
        拡張事業３７検査方法 = 3019 * 100000000L + 257201,
        拡張事業３７用一次検診コード = 3019 * 100000000L + 257202,
        拡張事業３８検査方法 = 3019 * 100000000L + 257401,
        拡張事業３８用一次検診コード = 3019 * 100000000L + 257402,
        拡張事業３９検査方法 = 3019 * 100000000L + 257601,
        拡張事業３９用一次検診コード = 3019 * 100000000L + 257602,
        拡張事業４０検査方法 = 3019 * 100000000L + 257801,
        拡張事業４０用一次検診コード = 3019 * 100000000L + 257802,
        拡張事業４１検査方法 = 3019 * 100000000L + 258001,
        拡張事業４１用一次検診コード = 3019 * 100000000L + 258002,
        拡張事業４２検査方法 = 3019 * 100000000L + 258201,
        拡張事業４２用一次検診コード = 3019 * 100000000L + 258202,
        拡張事業４３検査方法 = 3019 * 100000000L + 258401,
        拡張事業４３用一次検診コード = 3019 * 100000000L + 258402,
        拡張事業４４検査方法 = 3019 * 100000000L + 258601,
        拡張事業４４用一次検診コード = 3019 * 100000000L + 258602,
        拡張事業４５検査方法 = 3019 * 100000000L + 258801,
        拡張事業４５用一次検診コード = 3019 * 100000000L + 258802,
        拡張事業４６検査方法 = 3019 * 100000000L + 259001,
        拡張事業４６用一次検診コード = 3019 * 100000000L + 259002,
        拡張事業４７検査方法 = 3019 * 100000000L + 259201,
        拡張事業４７用一次検診コード = 3019 * 100000000L + 259202,
        拡張事業４８検査方法 = 3019 * 100000000L + 259401,
        拡張事業４８用一次検診コード = 3019 * 100000000L + 259402,
        拡張事業４９検査方法 = 3019 * 100000000L + 259601,
        拡張事業４９用一次検診コード = 3019 * 100000000L + 259602,
        拡張事業５０検査方法 = 3019 * 100000000L + 259801,
        拡張事業５０用一次検診コード = 3019 * 100000000L + 259802,
        拡張事業１用精密検査コード = 3019 * 100000000L + 260001,
        接種種類コード = 3019 * 100000000L + 400001,
