...
{
    public class DaDbContext : IDisposable
    {
        public AiSessionContext Session { get; set; } = new AiSessionContext();

        public DaDbContext()
        {
            DaGlobal.InitDbLib();
            Session = new AiSessionContext(DaGlobal.ConnectionString);
            Session.SessionData[DaConst.SessionID] = 0L;
            Session.DbContext = this;
        }

        public DaDbContext(DaRequestBase req)
        {
            DaGlobal.InitDbLib();
            Session.Connection = AiGlobal.DbApi.GetConnection(DaGlobal.ConnectionString);
        ...
        public NpgsqlConnection Connection => (NpgsqlConnection)(Session.Connection!);
        ...
        ///母子保健詳細メニューマスタ
        ///</summary>
        public tm_bhkksyosaimenuDao tm_bhkksyosaimenu => new tm_bhkksyosaimenuDao(Session);
        ...
        ///乳幼児パーセンタイル値マスタ
        ///</summary>
        public tm_bhnypasentairuDao tm_bhnypasentairu => new tm_bhnypasentairuDao(Session);
        ...
        ///予防接種その他テーブル
        ///</summary>
        public tt_yssonotaDao tt_yssonota => new tt_yssonotaDao(Session);
