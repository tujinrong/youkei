...
Private iPage As Integer = 0                'ページ
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Const con_ReportName As String = "≪ 支店・支所一覧表 ≫"
    ...
    Public Function Report(param As String) As MemoryStream Implements InterfaceRptGJ8052.Report
      
        Dim pr = System.Text.Json.JsonSerializer.Deserialize(Of JBD.GJS.Service.GJ8050.PreviewSitenRequest)(param)
        
        '検索結果出力用ＳＱＬ作成
        Dim sql = FrmGJ8050Service.f_make_SQL2(pr)
