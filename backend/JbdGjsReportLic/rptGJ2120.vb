...
Interface InterfaceRptGJ2120
    Sub sub1(wkDSRep As DataSet, pFlag As Integer)
End Interface
Public Class rptGJ2120
    Implements InterfaceRptGJ2120

    Property pSyoriKbn As Integer
    Property pKikin2 As Boolean     '2017/07/19　追加
    ...
    Private Sub s_FurikomiDsp(ByVal wEnable As Boolean)
        ...
        txt_FURI_FT31.Visible = wEnable     '2017/07/19　追加

    End Sub
    Sub sub1(wkDSRep As DataSet, pFlag As Integer) Implements InterfaceRptGJ2120.sub1
