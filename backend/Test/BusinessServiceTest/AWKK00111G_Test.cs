...
namespace BCC.Affect.Service.AWKK00111G
{
    ...
    public class AWKK00111G_Test
    {
        ...
        //[TestMethod]
        ////世帯情報検索テスト用
        //public void SearchSetaiTest()
        //{
        //    var req = new SearchSetaiRequest
        //    {
        //        userid = "1",                                          //ユーザーID
        //        regsisyo = "1",
        //        kinoid = "AWKK00111G",
        ...
        //        setaino = "700000000000004",                    //宛名番号
        //    };

        //    var res = _service.SearchSetai(req);
        ...
        public void SaveTest()
        {
            ...
            {
                rirekino = 7,
                upddttm = CDate("2022-01-01"),
                saisin = "",
                stop = "",
                idoymd = "2024-07-01",
                idotodokeymd = "2024-06-19",
                idojiyu = "01 : 記載_国内転入",
                setaino = "9199999999070",
                senusinm = "",
                adrs_tyoazacd = "013001 : 桜町",
                //atenano = "929999990001",
                //atenano = "000000000900001",
                atenano = "200706121234567",
                personalno = "",
                jutogaisyasyubetu = "1 : 日本人住民",
                jutogaisyajotai = "4 : 住登外者",
                juminkbn = "",
                si = "田中",
                mei = "麗子",
                sex = "2 : 女",
                ...
                adrs_kokunm = "",
                sansyofuka = "2 : 参照可能",
                nayosemotoflg = "2 : 該当する",
                nayosesakiatenano = "800000000000001",
                togoatenaflg = "2 : 該当する",
                regbusyocd = "3 : 登録部署テスト３",
                tusyo_kanastatus = "0",
                adrs_yubin = "0338666",
                tosi_gyoseikucd = "131010001001 : 東京都千代田区",
                adrs_tyoaza = "桜町",
                adrs_sikucd = "22071 : 青森県三沢市",
                adrs_todofuken = "青森県",
                adrs_sikunm = "三沢市",
                si_kana = "ﾀﾅｶ",
                mei_kana = "レイコ",
                adrs_kokunmcd = "KOR  : 大韓民国",
                adrs_gaiadrs = "ソウルみゃんど地区　４５メインStreet　後ろスペース入力した",
                hokenkbn = "10 : 国保",
                bymd = "2002-01-26",
                bymd_fusyohyoki = "不詳でない"
            };
