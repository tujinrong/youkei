...
namespace BCC.Affect.Service.AWYS00101G
{
    ...
    public class AWYS00101G_Test
    {
        ...
        //        atenano = "800000000000009",                        //宛名番号
        //        checkflg = true,                                    //チェックフラグ
        //    };

        //    var fixiteminfo = new FixItemSessyuBaseVM()
        //    {
        //        sessyu = "1000113 : 三種混合(1期初回3回目)",        //接種種類
        //        edano = 0,                                          //枝番
        //        jissiymd = "2020-01-02",                            //実施日
        //        sessyukbn = "1 : 接種",                             //接種区分
        //        lotno = "4K23B",                                    //ロット番号
        ...
        //[TestMethod]
        ////罹患情報詳細画面保存テスト用
        //public void SaveRikanTest()
        //{
        //    //保存の場合
        //    var req = new SaveRikanRequest
        //    {
        //        userid = "1",
        //        regsisyo = "1",
        //        token = "Vwdu6wgvN/pJZCJV9S0sCA==",                 //alertviewflg=false 4084
        ...
        //    var kekkalist = new List<SessyuRikanBaseVm>();

        //    var vm = new SessyuRikanBaseVm()
        //    {
        //        rikan = "1 : 麻しん",                               //罹患コード
        //        haakuymd = "2020-01-01",                            //把握日
        //    };
        //    kekkalist.Add(vm);

        //    vm = new SessyuRikanBaseVm()
        //    {
        //        rikan = "2 : 風しん",                               //罹患コード
        //        haakuymd = "2020-01-02",                            //把握日
        //    };
        //    kekkalist.Add(vm);
        ...
        //    {
        //        rikan = "4 : 水痘",                                   //罹患コード
        //        haakuymd = "2020-01-04",                              //把握日
        //    };
        //    kekkalist.Add(vm);

        //    vm = new SessyuRikanBaseVm()
        //    {
        //        rikan = "99 : 母子感染対象",                               //罹患コード
        //        haakuymd = "2020-01-05",                            //把握日
        //    };
        //    kekkalist.Add(vm);

        //    req.kekkalist = kekkalist;

        //    var res = _service.SaveRikan(req);
