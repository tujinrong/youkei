...
import { RequestEnum, ContentTypeEnum, EnumServiceResult } from '@/enum'
...
import { CM_DBTIMEOUT_ERROR, CM_HTTP_ERROR } from '@/constants/msg'
...
const transform: AxiosTransform = {
  ...
  transformRequestData: (
    ...
    // リクエストは成功しました
    const hasSuccess =
      data && Reflect.has(data, 'code') && code === EnumServiceResult.OK
