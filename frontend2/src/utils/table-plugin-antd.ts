...
function getCellEditFilterProps(
  ...
  params:
    | VxeGlobalRendererHandles.RenderEditParams
    | VxeGlobalRendererHandles.RenderFilterParams,
  value: any,
  defaultProps?: { [prop: string]: any }
) {
  return XEUtils.assign({}, defaultProps, renderOpts.props, {
    [getModelProp(renderOpts)]: value,
  })
}
    ...
    return XEUtils.map(
      ...
      optionGroups
        ...
        : (value) => {
            ...
            return selectItem
              ? selectItem[valueProp] + ' : ' + selectItem[labelProp]
              : value
          }
    ).join(', ')
  }
 ...
 * @param params
 */
function defaultFuzzyFilterMethod(
  params: VxeGlobalRendererHandles.FilterMethodParams
) {
 ...
 * @param params
 */
function defaultExactFilterMethod(
  params: VxeGlobalRendererHandles.FilterMethodParams
) {
  const { option, row, column } = params
  const { data } = option
      ...
      DateJp: {
        ...
        renderCell(renderOpts, params) {
          return getCellLabelVNs(
            renderOpts,
            params,
            getDateJpCellValue(renderOpts, params)
          )
        },
      },
      AiSelect: {
        ...
        renderCell(renderOpts, params) {
          return getCellLabelVNs(
            renderOpts,
            params,
            getAiSelectCellValue(renderOpts, params)
          )
        },
      },
      ASelect: {
          ...
          return [
            h(
              ...
              optionGroups
                ? column.filters.map((option, oIndex) => {
                    const optionValue = option.data
                    const props = getCellEditFilterProps(
                      renderOpts,
                      params,
                      optionValue
                    )
      ...
      ACascader: {
        ...
        renderCell(renderOpts, params) {
          return getCellLabelVNs(
            renderOpts,
            params,
            getCascaderCellValue(renderOpts, params)
          )
        },
        renderItemContent: createFormItemRender(),
      ...
      ARangePicker: {
        ...
        renderCell(renderOpts, params) {
          return getCellLabelVNs(
            renderOpts,
            params,
            getRangePickerCellValue(renderOpts, params)
          )
        },
        renderItemContent: createFormItemRender(),
