export const CM_HTTP_ERROR = { No: 'E000001', Msg: 'サーバーとの接続に失敗しました。' }
export const CM_FATAL_ERROR = { No: 'E000002', Msg: '予期せぬエラーが発生しました。' }
export const CM_KEYDUPLICATE_ERROR = { No: 'E000003', Msg: 'キー重複エラーが発生しました。' }
export const CM_DEADLOCK_ERROR = { No: 'E000004', Msg: 'デッドロックエラーが発生しました。' }
export const CM_DBCONN_ERROR = { No: 'E000005', Msg: 'DB接続エラーが発生しました。' }
export const CM_DBTIMEOUT_ERROR = { No: 'E000006', Msg: 'タイムアウトエラーが発生しました。' }
export const CM_EXCLUSIVE_ERROR = {
  No: 'E000007',
  Msg: 'データを更新できません。\n他のユーザーによって変更された可能性があります。'
}
export const CM_AUTH_ERROR = { No: 'E000008', Msg: '認証エラーが発生しました。' }
export const CM_LOGINTIMEOUT_ERROR = {
  No: 'E000009',
  Msg: '長時間未操作のため、再びログインしてください。'
}
export const ITEM_REQUIRE_ERROR = { No: 'E001001', Msg: '{0}を入力してください。' }
export const ITEM_NOTEQUAL_ERROR = { No: 'E001002', Msg: '{0}と一致していません。' }
export const ITEM_ILLEGAL_ERROR = { No: 'E001003', Msg: '{0}を正しく入力してください。' }
export const ITEM_EQUAL_ERROR = { No: 'E001004', Msg: '{0}と一致しています。' }
export const ITEM_SELECTREQUIRE_ERROR = { No: 'E001005', Msg: '{0}を選択してください。' }
...
export const E001010 = { No: 'E001010', Msg: '桁数上限({0}文字)を超えています。' }
export const E001011 = { No: 'E001011', Msg: '現在、画面起動中です。{0}を表示出来ません。' }
export const E001012 = { No: 'E001012', Msg: 'アクセス権限がない為、{0}を表示出来ません。' }
export const E001013 = { No: 'E001013', Msg: '入力値が不正です。確認してください。' }
...
export const UPLOAD_ERROR = { No: 'E003001', Msg: 'アップロードは失敗しました。' }
...
export const E004005 = { No: 'E004005', Msg: 'パスワードは{0}を含めてください。' }
export const E004006 = { No: 'E004006', Msg: '{0}は{1}に存在しません。' }
export const E004007 = { No: 'E004007', Msg: '{0}は失敗しました。' }
export const E004008 = { No: 'E004008', Msg: '登録支所へ更新・削除権限がありません。' }
...
export const E014001 = { No: 'E014001', Msg: '該当{0}が使用されています。削除できません。' }
export const E014002 = { No: 'E014002', Msg: '氏と名の間に空白一文字を入れてください。' }
export const E014003 = {
  No: 'E014003',
  Msg: '該当取込設定が取込実行に使用されています。{0}できません。'
}
export const E014004 = { No: 'E014004', Msg: '{0}データがあるため、{1}できません。' }
export const E014005 = { No: 'E014005', Msg: '使用されています。変更できません。' }
export const E014006 = { No: 'E014006', Msg: '上限数に達しました、追加できません。' }
export const E014007 = { No: 'E014007', Msg: '{0}が入力できません。' }
export const E014008 = {
  No: 'E014008',
  Msg: '参加者情報のみの登録ができません。申込、あるいは結果情報を先に登録してください。'
}
export const E014009 = { No: 'E014009', Msg: '申込と結果情報の事業コードが一致していません。' }
export const E014010 = { No: 'E014010', Msg: '該当{0}が使用されています。変更できません。' }
...
export const E024001 = { No: 'E024001', Msg: '一次検診結果は、精密検査対象ではありません。' }
export const E024002 = { No: 'E024002', Msg: '同一年度内に一次検診を既に受診しています。' }
export const E024003 = {
  No: 'E024003',
  Msg: '精密検査の実施日は一次検診の実施日より前を入力できません。'
}
export const E024004 = { No: 'E024004', Msg: '一次検診結果が登録されていません。' }
export const E024005 = { No: 'E024005', Msg: '検診({0})が「対象外」です。' }
export const E024006 = { No: 'E024006', Msg: '今年度検診({0})を受診済です' }
export const E024007 = { No: 'E024007', Msg: '該当検診の受診対象外です。登録できません。' }
...
export const E064004 = { No: 'E064004', Msg: '基本CSV出力パターンを削除できません。' }
export const E064005 = { No: 'E064005', Msg: '追加項目コードは「1」で初めてください。' }
...
export const E064008 = { No: 'E064008', Msg: '使用できない文字{0}が入力されています。' }
export const E064009 = { No: 'E064009', Msg: '本日の日時を指定してください。' }
export const E064010 = { No: 'E064010', Msg: 'ファイル名には特殊文字が入っています。' }
...
export const E064014 = { No: 'E064014', Msg: '{0}が追加されました。{1}ができません。' }
export const E064015 = { No: 'E064015', Msg: '{0}を設定してください。' }
export const E064016 = { No: 'E064016', Msg: 'メインテーブルの項目は必要です。' }
export const E064017 = {
  No: 'E064017',
  Msg: '宛名フラグをチェックした場合、項目一覧に宛名番号の項目は必要 。'
}
export const E064018 = { No: 'E064018', Msg: 'フォーマットに区分の選択は間違っています。' }
export const E005001 = { No: 'E005001', Msg: 'プロシジャー保存エラーが発生しました。' }
export const DOWNLOAD_NOTEXIST_ALERT = {
  No: 'A000001',
  Msg: 'ダウンロードファイルが見つかりません。'
}
export const ITEM_REQUIRE_ALERT = { No: 'A000002', Msg: '{0}を入力してください。' }
export const A000003 = {
  No: 'A000003',
  Msg: '警告情報が登録されている方です。ご注意ください。\n警告内容：{0}'
}
export const A000004 = { No: 'A000004', Msg: '不詳の日付を入力しています。ご注意ください。' }
export const A000005 = {
  No: 'A000005',
  Msg: 'この画面の新規権限がありません。\n次の画面へ遷移できません。'
}
export const ITEM_ILLEGAL_ALERT = { No: 'A000007', Msg: '{0}を正しく入力してください。' }
...
export const A060002 = { No: 'A060002', Msg: '{0}は複数項目にチェックされました。' }
...
export const DOWNLOAD_OK_INFO = { No: 'I000003', Msg: 'ダウンロード処理が完了しました。' }
export const SAVE_OK_INFO = { No: 'I000004', Msg: '登録処理が完了しました。' }
export const DELETE_OK_INFO = { No: 'I000005', Msg: '削除処理が完了しました。' }
export const UPLOAD_OK_INFO = { No: 'I000006', Msg: 'アップロード処理が完了しました。' }
export const I000007 = { No: 'I000007', Msg: 'パスワードを変更しました。' }
export const SERVER_START_INFO = { No: 'I000008', Msg: 'サーバーが起動しました。' }
...
export const I011002 = { No: 'I011002', Msg: '照会が完了しました。\n照会結果は{0}件です。' }
export const I060001 = { No: 'I060001', Msg: '編集完了しました。' }
export const I060002 = { No: 'I060002', Msg: 'セルをクリックして項目内容を設定してください。' }
export const SAVE_CONFIRM = { No: 'C001001', Msg: '登録処理を行います。\nよろしいですか？' }
...
export const DELETE_CONFIRM = { No: 'C001004', Msg: '削除処理を行います。\nよろしいですか？' }
export const CLEAR_CONFIRM = { No: 'C001005', Msg: '入力値がクリアされます。\nよろしいですか？' }
...
export const C001009 = { No: 'C001009', Msg: 'アカウントの{0}を行います。\nよろしいですか？' }
...
export const C001014 = { No: 'C001014', Msg: '取込実行処理を行います。\nよろしいですか？' }
export const C001015 = {
  No: 'C001015',
  Msg: '【正常】{0}件\n【情報】{1}件\n【警告】{2}件\n【エラー】{3}件\n正常、情報、警告のデータのみ処理を継続しますか？\n（登録後エラーデータも削除します）'
}
export const C001016 = { No: 'C001016', Msg: '仮保存処理を行います。\nよろしいですか？' }
...
export const C011002 = { No: 'C011002', Msg: '事業コード管理を設定します。よろしいですか？' }
export const C011003 = {
  No: 'C011003',
  Msg: 'チェックを外すと登録時に削除されます。よろしいですか？'
}
export const C011004 = { No: 'C011004', Msg: '定員オーバーになります。\n申込を続けますか？' }
export const C011005 = { No: 'C011005', Msg: '申込登録出来ない{0}がいます。\n登録を続けますか？' }
...
export const C021001 = { No: 'C021001', Msg: 'この画面は年度切替画面です。処理を続けますか？' }
export const C021002 = { No: 'C021002', Msg: '一時対象サインデータを作成しますか？' }
export const C021003 = { No: 'C021003', Msg: '日程番号を変更します。よろしいですか？' }
export const C021004 = { No: 'C021004', Msg: '受診済データですが、クリアしてもよろしいですか？' }
...
export const C002005 = { No: 'C002005', Msg: '画面情報を上書きします。\nよろしいですか？' }
export const C002006 = {
  No: 'C002006',
  Msg: '登録処理を行っていません。\n画面情報を上書きします。\nよろしいですか？'
}
export const C002007 = { No: 'C002007', Msg: 'エラーリストの出力を行います。\nよろしいですか？' }
export const C003001 = {
  No: 'C003001',
  Msg: 'パスワードの有効期限まであと{0}日です。パスワードを変更しますか？'
}
export const LOGOUT_CONFIRM = { No: 'C003002', Msg: 'ログアウトします。\nよろしいですか？' }
export const C003003 = { No: 'C003003', Msg: '{0}画面へ遷移します。\nよろしいですか？' }
export const C003004 = { No: 'C003004', Msg: 'お気に入りに追加します。\nよろしいですか？' }
export const C003005 = { No: 'C003005', Msg: 'お気に入りから削除します。\nよろしいですか？' }
...
export const K000001 = { No: 'K000001', Msg: '{0}\n必要な場合、{1}を変更してください。' }
...
export const K024002 = { No: 'K024002', Msg: '一次検診結果が登録されていません。よろしいですか？' }
export const K024003 = { No: 'K024003', Msg: '該当検診の受診対象外です。よろしいですか？' }
...
export const J000001 = { No: 'J000001', Msg: '取込実行処理は完了しました。（登録件数：{0}）' }
export const J024001 = { No: 'J024001', Msg: '対象者は、予約申込していません。' }
