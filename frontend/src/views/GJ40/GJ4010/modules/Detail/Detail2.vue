  ...
  >
    <div class="parent-container">
      <div class="edit_table form w-full">
        <h2 class="mt3 mb1">1. 申請者名等</h2>
        <a-row>
          <a-col span="24">
            <read-only-pop th="契約者番号" thWidth="110" :td="formData.KEIYAKUSYA_CD"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
            <read-only-pop thWidth="110" th="契約区分" td="" :td="formData.KEIYAKUSYA_NAME"/>
          </a-col>
        </a-row>
        <h2 class="mt3 mb1">2. 農場別種類別互助金申請明細登録</h2>
        <a-row>
          <a-col span="8">
        ...
        <div class="my-2 my-table">
          <table>
            <tr>
              ...
              <th style="width: 160px">交付対象農場における<br>1羽1ヶ月当たりの</th>
              <th style="width: 30px"></th>
            ...
            <tr>
              <th rowspan="2" style="text-align: left;border-bottom: none;">④空舎期間の補正</th>
            ...
            <tr>
              ...
              <td style="border-bottom: none;">{{ hasuGokei.SAIRANKEI_IKUSEIKEI }}</td>
              <td style="border-bottom: none;">＝</td>
          ...
          <table>
            <tr>
              <th rowspan="2" style="width: 160px;text-align: left;">互助金交付単価の算定</th>
          ...
          <table>
            <tr>
              <th rowspan="2" style="width: 160px;text-align: left;border-top: none;">互助金交付単価の算定</th>
        ...
        <table class="last-table">
          ...
          <tr>
            ...
            <th rowspan="2" style="text-align: left">経営支援互助金 算定(※1-※2)</th>
            <td>{{ hasuGokei.SAIRANKEI_SEIKEI }}</td>
            <th style="text-align: center">×</th>
          ...
          <tr>
            ...
            <td>{{ hasuGokei.SAIRANKEI_SEIKEI }}</td>
            <td colspan="7" style="text-align: left">①積立金交付金額 ＋ ②国庫交付金額</td>
          </tr>
          <tr>
