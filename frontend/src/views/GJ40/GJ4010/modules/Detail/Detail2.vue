<template>
  ...
  >
    <a-tabs v-model:activeKey="tab">
      ...
      ></a-tab-pane>
      <a-tab-pane key="2" tab="2.農場別種類別互助金申請明細登録"
        ><div class="edit_table form w-full">
          <a-row>
            <a-col span="12">
          ...
          <div class="my-2 my-table">
            ...
            <table>
              <tr>
                ...
                <th style="width: 190px; border-top: none">
                  別表２の交付上限単価
                </th>
                <th style="width: 190px; border-top: none">
                  ⑧算定交付上限単価
