  ...
  >
    <div class="parent-container">
      <div class="self_adaption_table form w-full">
        ...
        <a-row>
          <a-col span="24">
            <read-only thWidth="110" th="契約者名" td="" :td="formData.KEIYAKUSYA_NAME"/>
          </a-col>
        </a-row>
        <h2 class="mt3 mb1">請求入金内容</h2>
        <a-row>
          <a-col span="24">
            <read-only th="対象期" thWidth="110" :td="formData.KI" />
          </a-col>
        </a-row>
        <a-row>
          <a-col span="12">
            <read-only th="請求日" thWidth="110" :td="formData.SEIKYU_DATE" />
          </a-col>
          <a-col span="12">
            <read-only th="請求回数" thWidth="110" :td="formData.SEIKYU_KAISU" after="回" />
          </a-col>
        </a-row>
        <a-row>
          <a-col span="6">
            <read-only thWidth="110" th="請求金額" :td="formData.SAGUKU_SEIKYU_KIN" v-bind="{ ...mathNumber }" after="円"/>
          </a-col>
          <a-col span="6">
            <read-only thWidth="110" th="積立金額" :td="formData.TUMITATE_KIN" v-bind="{ ...mathNumber }" after="円"/>
          </a-col>
          <a-col span="6" style="flex-flow: column;">
            <div class="flex"><read-only thWidth="110" th="手数料" :td="formData.TESURYO" v-bind="{ ...mathNumber }" after="円"/></div>
            <div class="flex"><read-only thWidth="110" th="積立金等総計" :td="formData.SEIKYU_KIN" after="円"/></div>
          </a-col>
          <a-col span="6">
            <read-only thWidth="80" th="返還金額(預かり金)" :td="formData.TESURYO" v-bind="{ ...mathNumber }" after="円"/>
          </a-col>
        </a-row>
        <a-row class="mt4">
          <a-col span="16">
          ...
          <a-col span="8">
            <a-row>
              <a-col span="24">
                <read-only thWidth="80" th="積立金額計" :td="formData.SEIKYU_KIN" after="円"/>
              </a-col>
              <a-col span="24">
                <read-only thWidth="80" th="手数料額計" :td="formData.SEIKYU_KIN" after="円"/>
              </a-col>
              <a-col span="12">
                <read-only thWidth="80" th="入金額計" :td="formData.SEIKYU_KIN" after="円"/>
              </a-col>
              <a-col span="12">
                <read-only thWidth="80" th="入金額残" :td="formData.SEIKYU_KIN" after="円"/>
              </a-col>
            </a-row>
          </a-col>
        </a-row>
        ...
        <a-row>
          <a-col span="24">
            ...
            <read-only thWidth="100" th="積立金額" :td="formData.BANK_NAME" after="(返還金額(預かり金) + 入金額)"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
            ...
            <read-only thWidth="100" th="手数料額" :td="formData.FURI_KOZA_NO"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
            ...
            <read-only thWidth="100" th="入金額" :td="formData.FURI_KOZA_MEIGI_KANA"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
    ...
    <template #footer>
      <div class="pt-2 flex justify-between border-t-1">
        <a-space :size="20">
          <a-button class="warning-btn" :disabled="!formData.NYUKIN_DATE" @click="saveData">保存</a-button>
          <a-button :disabled="!formData.NYUKIN_DATE" @click="closeModal">キャンセル</a-button>
        </a-space>
