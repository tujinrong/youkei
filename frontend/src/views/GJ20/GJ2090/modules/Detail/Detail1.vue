  ...
  >
    <div class="parent-container">
      <div class="self_adaption_table form w-full">
        ...
        <a-row>
          <a-col span="24">
            <read-only thWidth="140" th="契約者名" td="" :td="formData.KEIYAKUSYA_NAME"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
        ...
        <a-row>
          <a-col span="24">
            <read-only thWidth="140" th="" :hideTd="true" />
            <read-only thWidth="130" th="口座種別" :td="formData.FURI_KOZA_SYUBETU_NAME"/>
            <read-only thWidth="130" th="口座番号" :td="formData.FURI_KOZA_NO"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
            <read-only thWidth="140" th="" :hideTd="true" />
            <read-only thWidth="130" th="口座名義人(カナ)" :td="formData.FURI_KOZA_MEIGI_KANA"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
            <read-only th="事務委託先" thWidth="140" :td="formData.JIMUITAKU_CD" />
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
            <read-only th="事務委託先名" thWidth="140" :td="formData.ITAKU_NAME" />
          </a-col>
        </a-row>
        ...
        <a-row>
          <a-col span="8">
            <read-only th="請求・返還日" thWidth="140" :td="formData.SEIKYU_DATE" />
          </a-col>
          <a-col span="8">
            <read-only th="請求・返還回数" thWidth="110" :td="formData.SEIKYU_KAISU" after="回" />
          </a-col>
          <a-col span="8">
            <read-only th="請求・返還区分" thWidth="110" :td="formData.SEIKYU_HENKAN_KBN_NAME" />
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
        ...
        <a-row>
          <a-col span="24">
            <read-only thWidth="140" th="請求・返還金額" :td="formData.SAGUKU_SEIKYU_KIN" v-bind="{ ...mathNumber }" after="円"/>
            <read-only thWidth="130" th="積立金額" :td="formData.TUMITATE_KIN" v-bind="{ ...mathNumber }" after="円"/>
            <read-only thWidth="130" th="手数料" :td="formData.TESURYO" v-bind="{ ...mathNumber }" after="円"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
            ...
            <read-only thWidth="130" th="積立金等総計" :td="formData.SEIKYU_KIN" after="円"/>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="24">
    ...
    <template #footer>
      <div class="pt-2 flex justify-between border-t-1">
        <a-space :size="20">
          ...
          <a-button :disabled="!formData.NYUKIN_DATE" @click="closeModal">入金取消</a-button>
          <a-button :disabled="!formData.NYUKIN_DATE" @click="openGJ2092">分割入金</a-button>
        </a-space>
