        ...
        <a-row :gutter="[0, 16]">
          <a-col span="24">
            ...
            <td class="flex items-center">
              <a-input-number v-model:value="formData.KI" style="width: 33.3%" :max="99" :min="1">
          ...
          <a-col span="24">
            ...
            <td>
              <a-form-item>
                <YearJp v-model:value="formData.TAISYO_NENDO" style="width: 33.3%" />
              </a-form-item>
            </td>
          </a-col>
          ...
          <a-col span="24">
            <th>現在の認定回数</th>
            <td>
              <a-input-number v-model:value="formData.HASSEI_KAISU" style="width: 33.3%" :max="99" :min="1">
