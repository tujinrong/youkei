<template>
  <div class="table-area-detail">
    <a-tabs
      ...
      @change="tabClick"
    >
      <a-tab-pane key="1" tab="依頼" :closable="false">
        <RightTabDetail_pat2
          ref="tab1Ref"
          :grouplist1="grouplist1"
          :grouplist2="grouplist2"
          :bhsyosaimenyucd="_113"
          :bhsyosaitabcd="タブコード_1"
          :bosikbn="子_2"
        />
      </a-tab-pane>
      <a-tab-pane key="2" tab="健診結果" :closable="false">
        <RightTabDetail_pat2
          ref="tab2Ref"
          :grouplist1="grouplist1"
          :grouplist2="grouplist2"
          :bhsyosaimenyucd="_114"
...
import { _113, _114, 子_2, タブコード_3, タブコード_1, タブコード_2 } from '../../constant'
