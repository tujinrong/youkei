<template>
  <div class="table-area-detail">
    <a-tabs
      ...
      @change="tabClick"
    >
      <a-tab-pane key="1" tab="スクリーニング検査費用助成" :closable="false">
        <RightTabDetail_pat2
          ref="tab1Ref"
          :grouplist1="grouplist1"
          :grouplist2="grouplist2"
          :bhsyosaimenyucd="_103"
          :bhsyosaitabcd="タブコード_1"
          :bosikbn="子_2"
        />
      </a-tab-pane>
      <a-tab-pane key="2" tab="聴覚検査結果" :closable="false">
        <RightTabDetail
          ref="tab2Ref"
          :grouplist1="grouplist1"
          :grouplist2="grouplist2"
          :bhsyosaimenyucd="_102"
...
import { _103, _102, 子_2, 履歴回数_0, タブコード_1, タブコード_2 } from '../../constant'
