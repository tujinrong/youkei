  ...
  <a-spin :spinning="loading">
    <a-card :bordered="false">
      ...
      <div class="m-t-1 flex justify-between">
        <a-space>
          <a-button v-if="addFlg || updFlg" type="warn" @click="saveData">登録</a-button>
          <a-button v-if="delFlg" type="primary" danger @click="deleteData">削除</a-button>
          <a-button type="primary" @click="Ref_402?.open">発育曲線</a-button>
    ...
    <a-card
      class="my-2"
      :loading="loading"
      :style="{ marginBottom: height + 8 + 'px', height: 700 + 'px' }"
    >
      <TableArea ref="TableAreaRef" :grouplist1="grouplist1" :grouplist2="grouplist2" />
    </a-card>
    <OperationFooter ref="footerRef" />
    <AWBH00402D ref="Ref_402" />
  </a-spin>
</template>
...
import { HeaderInfoVM, SaveRequest, DeleteRequest, TabInfoVM } from '../type'
...
import { SearchDetail, Save, Delete } from '../service'
import { 子_2 } from '../constant'
import AWBH00402D from '../page/AWBH00402D/index.vue'
...
const Ref_402 = ref<InstanceType<typeof AWBH00402D> | null>(null)
...
function getData() {
  ...
  console.log(saveDataList.value)
}
