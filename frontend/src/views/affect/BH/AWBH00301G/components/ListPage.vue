      ...
      <div class="self_adaption_table form">
        <a-row>
          ...
          <a-col :md="12" :lg="12" :xl="8" :xxl="6">
            <th>母子手帳番号</th>
            <td>
              <a-input v-model:value="searchParams.bhtetyono" />
            </td>
          </a-col>
        </a-row>
      </div>
    ...
    <a-card class="mt-2">
      ...
      <div :style="{ height: tableHeight }">
        ...
        >
          ...
          <vxe-column
            field="syosai"
            title="妊娠届出|手帳交報|出産状態|妊婦健診|妊婦精健|歯科健診|歯科精健|産婦健診|精密健診|産後ケア"
            min-width="90"
          ></vxe-column>
          <vxe-column
            field="bhtetyono"
...
import { useBoolean, useTableHeight } from '@/utils/hooks'
