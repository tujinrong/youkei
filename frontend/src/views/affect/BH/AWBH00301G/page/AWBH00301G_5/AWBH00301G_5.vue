<template>
  <div class="table-area-detail">
    <a-tabs
      ...
      @change="tabClick"
    >
      <a-tab-pane key="1" tab="妊婦健診結果" :closable="false">
        <RightTabDetail_pat2
          ref="tab1Ref"
          :grouplist1="grouplist1"
          :grouplist2="grouplist2"
          :bhsyosaimenyucd="_105"
          :bhsyosaitabcd="タブコード_1"
          :bosikbn="母_1"
        />
      </a-tab-pane>
      <a-tab-pane key="2" tab="妊婦健診費用助成" :closable="false">
        <RightTabDetail_pat2
          ref="tab2Ref"
          :grouplist1="grouplist1"
          :grouplist2="grouplist2"
          :bhsyosaimenyucd="_106"
...
import { _105, _106, 履歴回数_1, 母_1, タブコード_1, タブコード_2, page_pat1 } from '../../constant'
