                      ...
                      <table>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td colspan="3">
                              {{ showSisyo ? item.regsisyo?.split(' : ')[1] : '' }}
                            </td>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th width="9%" class="bg-readonly">登録支所</th>
                        <td colspan="3">{{ regsisyo }}</td>
                      </tr>
                      <tr>
...
import { SearchRequest, SaveRequest, HeaderVM } from './type'
...
import { AddVM, LockVM, SearchVM } from '../AWAF00601D/type'
...
//タブキー
const activeKey_type = ref('1') //メ　モ 既往歴 家族歴 Key
...
//--------------------------------------------------------------------------
//操作権限取得
const kengen = computed(() => getBarKengen(Enum共通バー番号.メモ情報_世帯))
      ...
      showSaveModal({
        onOk: async () => {
          ...
          let saveParams: SaveRequest = {
            setaino: userInfo.value?.setaino as string,
