...
import { FollowDetailVM, InitFollowDetailResponse } from '@/views/affect/KK/AWKK00401G/type'
...
import DetailPageCtx from '@/views/affect/KK/AWKK00401G/components/DetailPageCtx.vue'
...
const canDelete = computed(
  () => !props.copyflg && !isNew && kengen.value.deleteflg && formData.updflg
)
//--------------------------------------------------------------------------
//フック関数
//--------------------------------------------------------------------------
