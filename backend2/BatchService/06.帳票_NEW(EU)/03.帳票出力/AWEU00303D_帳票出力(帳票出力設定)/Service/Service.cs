    ...
    public class Service : BtServiceBase, IBtService
    {
        ...
        public void Execute(string? jobId, object? param = null, long? sessionseq = null, bool? nowFlg = false)
        {
            Transction(jobId, sessionseq, param, nowFlg, db =>
            {
                ...
                DaEucService.MakeSheet(db, workseq, pm.rptid, pm.yosikiid, pm.reporttype, pm.searchdic, pm.detaildearchdic, pm.outputInfoDic, pm.orderbylist, pm.memo, pm.sessionseq,
                    pm.reguserid, pm.regsisyo, pm.hasupdatesql, pm.isblank, pm.hasconditionsheet, pm.hasupdhassorireki);
            });
        }
