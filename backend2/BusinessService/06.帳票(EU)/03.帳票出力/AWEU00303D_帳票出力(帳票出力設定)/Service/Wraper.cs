...
namespace BCC.Affect.Service.AWEU00303D
{
    public class Wraper : CmWraperBase
    {
        ...
        /// バッチ処理
        /// </summary>
        public static ParameterModel GetBatchParameter(BatchRequest req, bool nowFlg)
        {
            ...
            pm.outputInfoDic = CommonUtil.GetOutPutInfo(req.outPutInfo, req.outputfilenm); //出力情報
            return pm;
        }
    }
}