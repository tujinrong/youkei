...
namespace BCC.Affect.Service.AWKK00901G
{
    ...
    public class Service : CmServiceBase
    {
        ...
        public InitNitteiDetailResponse InitNitteiDetail(InitNitteiDetailRequest req)
        {
            return Nolock(req, (DaDbContext db) =>
            {
                //-------------------------------------------------------------
        ...
        public InitCourseDetailResponse InitCourseDetail(InitCourseDetailRequest req)
        {
            return Nolock(req, (DaDbContext db) =>
            {
                //-------------------------------------------------------------
        ...
        public static InitListResponse GetInitListResponse(DaDbContext db, string kinoid, InitListResponse res, bool hasStopFlg)
        {
            ...
            //-------------------------------------------------------------
            //業務区分一覧
            res.selectorlist1 = DaNameService.GetSelectorList(db, EnumNmKbn.拡_予約_保健指導業務区分, Enum名称区分.名称);
            //予約事業一覧
