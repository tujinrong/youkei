...
namespace BCC.Affect.Service.AWYS00101G
{
    ...
    /// </summary>
    public class SearchDetailOneRequest : SearchDetailMultiRequest
    {
        public bool rirekihyoji { get; set; } = false;                  //履歴表示フラグ　True：全枝番の情報を表示、False：最大枝番の情報を表示
    }
    ...
    {
        public string sessyufilterkbn { get; set; } = String.Empty;     //接種種類フィルター区分
    }
