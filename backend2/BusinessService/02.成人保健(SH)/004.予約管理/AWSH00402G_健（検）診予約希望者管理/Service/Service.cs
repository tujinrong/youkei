...
namespace BCC.Affect.Service.AWSH00402G
{
    ...
    public class Service : CmServiceBase
    {
        ...
        private const string KANEN = "02";
        private const string KANEN_B = "101901239001";
        private const string KANEN_C = "101901241001";
        ...
        public InitDetailResponse InitDetail(InitDetailRequest req)
        {
            return Nolock(req, (DaDbContext db) =>
            {
                ...
                //B型肝炎
                var existB = db.tm_shfreeitem.SELECT.WHERE.ByKey(new object[] { KANEN, KANEN_B }).Exists();
                //C型肝炎
                var existC = db.tm_shfreeitem.SELECT.WHERE.ByKey(new object[] { KANEN, KANEN_C }).Exists();
                //対象サイン
