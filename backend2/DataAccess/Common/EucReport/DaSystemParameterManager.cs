...
namespace BCC.Affect.DataAccess
{
    ...
    public class DaSystemParameterManager
    {
        ...
        {
            var rptDto = db.tm_eurpt.GetDtoByKey(rptID);
            SystemParameterDic = new Dictionary<string, IDaEucSystemParameterItem>()
            {
                ...
                { EnumSystemParameter.P_NINSANPU_FLG.ToString(), new DaEucSystemInfo_P_NINSANPU_FLG(db,rptDto.ninsanpuflg)},
                ...
                { EnumSystemParameter.P_HAKKODATASYOSAI_KBN.ToString(), new DaEucSystemInfo_P_HAKKODATASYOSAI_KBN(db, rptDto!, condition)},
                ...
                { JapNameDic[EnumSystemParameter.P_NINSANPU_FLG], new DaEucSystemInfo_P_NINSANPU_FLG(db,rptDto.ninsanpuflg)},
                ...
                { JapNameDic[EnumSystemParameter.P_HAKKODATASYOSAI_KBN], new DaEucSystemInfo_P_HAKKODATASYOSAI_KBN(db, rptDto!, condition)},
    ...
    /// 妊産婦フラグ 
    /// </summary>
    public class DaEucSystemInfo_P_NINSANPU_FLG : DaEucSystemInfoBase_Gamen, IDaEucSystemParameterItem
    {
        public DaEucSystemInfo_P_NINSANPU_FLG(DaDbContext db, bool ninsanpuflg)
        {
            _db = db;
            Ninsanpuflg = Ninsanpuflg;
        }
    ...
    /// 発行データ詳細区分
    /// </summary>
    public class DaEucSystemInfo_P_HAKKODATASYOSAI_KBN : DaEucSystemInfoBase_Gamen, IDaEucSystemParameterItem
    {
        public DaEucSystemInfo_P_HAKKODATASYOSAI_KBN(DaDbContext db, tm_eurptDto rptDto, ArConditionModel? condition)
        {
            _db = db;
            _condition = condition;
            ...
            if (rptDto.tyusyutupanelflg)
            {
                if (_condition != null && _condition.searchDic.TryGetValue(EnumSystemParameter.P_TYUSYUTU_TAISYO_CD.ToString(), out var taisyocd))
                {
                    ...
                    {
                        //発行データ詳細区分
                        var dto = db.tm_kktyusyutu.GetDtoByKey(taisyocd?.ToString() ?? "");
                        if (dto != null)
                        {
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(rptDto.yosikihimonm))
                {
                    ...
                    var dto = db.tm_eurptkensaku.SELECT.WHERE.ByFilter(filter).GetDto();
                    if (dto != null)
                    {
