...
--母子保健詳細メニューマスタ
INSERT INTO tm_eutable VALUES('tm_bhkksyosaimenyu','tm_bhkksyosaimenyu','母子保健詳細メニューマスタ', '3', false, 1) ON CONFLICT (tablealias) DO NOTHING;
...
--乳幼児パーセンタイル値マスタ
INSERT INTO tm_eutable VALUES('tm_bhnyhpasentairu','tm_bhnyhpasentairu','乳幼児パーセンタイル値マスタ', '3', false, 1) ON CONFLICT (tablealias) DO NOTHING;
