...
変更履歴　:
*******************************************************************/
create or replace function sp_awaf00803g_12(logkbn_in integer, status_in character varying, 
 ...
 (セッションシーケンス bigint,
  ...
  登録日時 text,
  "DB_DB操作ログシーケンス" bigint,
  "DB_セッションシーケンス" bigint,
  "DB_SQL" character varying,
  "DB_メッセージ" character varying,
  "DB_登録ユーザーID" character varying,
  "DB_登録日時" text)
 language plpgsql
as $function$
declare
...
begin
    ...
    select 
        ...
        ,t.dblogseq as "DB_DB操作ログシーケンス"
        ,t.seq2 as "DB_セッションシーケンス"
        ,t.sql as "DB_SQL"
        ,t.msg as "DB_メッセージ"
	    ,t.reguserid2 as "DB_登録ユーザーID"
        ,to_char(t.regdttm2, 'YYYY/MM/DD HH24:MI:SS') as "DB_登録日時"
    from (
        select
        ...
        inner join tt_aflogdb t9                    --DB操作ログテーブル
