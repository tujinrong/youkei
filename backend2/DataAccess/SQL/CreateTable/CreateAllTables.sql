...
comment on column tm_shkensinjigyo.kihonkakutyokbn is '基本／拡事業区分';
...
--母子保健詳細メニューマスタ
drop table if exists tm_bhkksyosaimenyu;
create table tm_bhkksyosaimenyu(
...
comment on table tm_bhkksyosaimenyu is '母子保健詳細メニューマスタ';
comment on column tm_bhkksyosaimenyu.bosikbn is '母子区分';
comment on column tm_bhkksyosaimenyu.bhsyosaimenyucd is '母子保健詳細メニューコード';
comment on column tm_bhkksyosaimenyu.bhsyosaimenyunm is '母子保健詳細メニュー名称';
comment on column tm_bhkksyosaimenyu.bhsyosaimenyushortnm is '母子保健詳細メニュー略称';
comment on column tm_bhkksyosaimenyu.orderseq is '並びシーケンス';
...
comment on column tm_bhkkjigyo.kihonkakutyokbn is '基本／拡事業区分';
...
--乳幼児パーセンタイル値マスタ
drop table if exists tm_bhnyhpasentairu;
create table tm_bhnyhpasentairu(
...
comment on table tm_bhnyhpasentairu is '乳幼児パーセンタイル値マスタ';
comment on column tm_bhnyhpasentairu.buicd is '部位コード';
comment on column tm_bhnyhpasentairu.sex is '性別';
comment on column tm_bhnyhpasentairu.month is '月';
comment on column tm_bhnyhpasentairu.date is '日';
comment on column tm_bhnyhpasentairu.pasentairucd is 'パーセンタイル値コード';
comment on column tm_bhnyhpasentairu.pasentairuti is 'パーセンタイル値';
comment on column tm_bhnyhpasentairu.regsisyo is '登録支所';
comment on column tm_bhnyhpasentairu.reguserid is '登録ユーザーID';
comment on column tm_bhnyhpasentairu.regdttm is '登録日時';
comment on column tm_bhnyhpasentairu.upduserid is '更新ユーザーID';
comment on column tm_bhnyhpasentairu.upddttm is '更新日時';
...
comment on column tm_eurpt.ninsanpuflg is '妊産婦フラグ';
